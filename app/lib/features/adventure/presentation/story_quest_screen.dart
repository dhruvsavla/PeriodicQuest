  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, bc) {
        ...
        return Center(
          child: Padding(
            padding: EdgeInsets.symmetric(horizontal: math.max(16.w, w * 0.06)),
            child: ConstrainedBox(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    '🗺️',
                    style: TextStyle(fontSize: math.min(80.sp, w * 0.20)),
                  ),
                  SizedBox(height: w * 0.06),
                  Text(
                    'Story Quest',
                    style: TextStyle(
                      fontSize: math.min(30.sp, w * 0.072),
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      fontSize: math.min(14.5.sp, w * 0.036),
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: const Color(0xFFD4B8FF), width: 2.w),
          ),
          child: Center(
